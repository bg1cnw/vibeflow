...
def default_state(project_root: Path, topic: str | None = None) -> dict:
    ...
    return {
        ...
        "artifacts": {
            ...
            "stories": f"{change_root}/stories.md",
            "prototype": f"{change_root}/prototype.md",
            "ui_spec": f"{change_root}/ui-spec.md",
...
def default_policy() -> dict:
    return {
        ...
        "phases": {
            ...
            "stories": {
                "required_artifacts": ["stories"],
                "required_checkpoints": [],
                "required_approvals": ["stories"],
                "completion_evidence": ["artifact:stories"],
                "blocking_conditions": [],
            },
            "prototype": {
                "required_artifacts": ["prototype"],
                "required_checkpoints": [],
                "required_approvals": ["prototype"],
                "completion_evidence": ["artifact:prototype"],
                "blocking_conditions": [],
            },
            "tasks": {
...
def update_active_change(state: dict, change_id: str) -> None:
    ...
    state["artifacts"] = {
        ...
        "stories": f"{root}/stories.md",
        "prototype": f"{root}/prototype.md",
        "ui_spec": f"{root}/ui-spec.md",
