...
| `vibeflow-browser-testing` | 测试阶段需要真实浏览器运行时证据 | 对页面交互类改动执行真实浏览器验证，统一采集 screenshot、console、network、a11y 证据；Playwright MCP 为主，DevTools MCP 为辅，本地 CLI 为 fallback。 |
